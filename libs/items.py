...
class AllItems:
    ### Weapons
    # Middle
    old_sword = Weapon("Старый гвоздь", 1.0, "Гвоздь, притупившийся в битвах",
    ...
    the_poisoned_dagger = Weapon("Отравленный кинжал", 3.3, "Позволяет отравить противника")
    bloody_sword = Weapon("Кровавый гвоздь", 3.5, "Неужели это...",
        interesting="На этом мече кровь босса...")
    # More Strong
    nail_pick = Weapon("Гвоздевая пика", 3.7, "Длинное копьё, бьёт на смерть")
    striking_nail = Weapon("Разящий гвоздь", 4.0, "Длинный увесистый гвоздь. Разит на повал, но медленный")
    the_blockhead = Weapon("Дубина", 4.3, "Дубина - хорошое оружие в ближнем бою")
    
    ### Armors
    busic_shell = Armor("Панцирь", 0.2,"Плохо сдержавает удары",
                             interesting="Создан природой")

    ### Items
    cape = Item("Накидка", "Кое-как спасает от ветра",
                             interesting="Развивается на ветру")
    basic_shield = Shield("Щит", lambda: random.randint(1,3)==1, "Поношенный и страрый",
